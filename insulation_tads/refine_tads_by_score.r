...
a$D25 = grepl("D25",a$samples)
a$num_stages = rowSums(a[,3:6])
...
true = data.frame(score=c[,-c(1:3,16)][a[,c(rep(7:12,each=1))]==TRUE],class="true")
false = data.frame(score=c[,-c(1:3,16)][a[,c(rep(7:12,each=1))]==FALSE],class="false")
